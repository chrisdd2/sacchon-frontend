...
export class DataService {
  ...
  getPatientAvg(type:string,date_start:Date,date_end:Date):Observable<AvgItem>{
    const params:HttpParams = new HttpParams();
    params.set('type',type);
    params.set('date_start',date_start.getTime().toString());
    params.set('date_end',date_end.getTime().toString());
